...
const getAll = async (req, res) => {
    try {
        ...
        for (const collection of collections) {
            ...
            if ( collectionName === 'admins' || collectionName === 'Categories' || collectionName === 'clients' || collectionName === 'sessions' || collectionName === 'notifications' || collectionName === 'orders' || collectionName === 'quotations' || collectionName === 'payments' ) {
                continue;
            }
